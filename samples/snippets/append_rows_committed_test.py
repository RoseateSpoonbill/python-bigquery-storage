...
from . import append_rows_committed
...
def test_append_rows_committed(
    ...
    assert (("customer_name", "Ming"), ("row_num", 4)) in row_items
    assert (("customer_name", "Vinay"), ("row_num", 5)) in row_items
    assert (("customer_name", "Roberto"), ("row_num", 6)) in row_items
